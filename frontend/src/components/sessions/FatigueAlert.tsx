  ...
  return (
    ...
    >
      <button
        ...
        className="absolute top-3 right-3 p-1 rounded hover:bg-[var(--bg-hover)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors"
        title="Dismiss"
      >
        <X size={14} />
      </button>
      ...
      <div className="flex items-start gap-3 pr-6">
        ...
        <div className="flex-1 min-w-0">
          <div className="font-medium text-[var(--text-primary)] mb-1" style={{ color: config.color }}>
            {config.title}
          </div>
