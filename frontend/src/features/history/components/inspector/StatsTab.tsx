  ...
  return (
    <>
      ...
      <div className="grid grid-cols-3 gap-3">
        <HeroStat label={t("inspector.score")} value={formatScore(primaryRun.score)} />
        <HeroStat label={t("inspector.accuracy")} value={formatPercent(primaryRun.accuracy)} />
        <HeroStat
