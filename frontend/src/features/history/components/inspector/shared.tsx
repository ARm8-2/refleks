...
export function StatsGroup({ label, children }: { label: string; children: ReactNode }) {
  return (
    <div className="rounded-xl bg-surface-subtle p-3">
      <div className="mb-2 text-xs font-medium text-surface-muted-foreground">{label}</div>
...
export function CompareMetric({ label, a, b, delta, lowerIsBetter }: {
  label: string
  a: string
  b: string
  delta?: number | null
...
export function CompareStatRow({ label, a, b }: { label: string; a: string; b: string }) {
  return (
